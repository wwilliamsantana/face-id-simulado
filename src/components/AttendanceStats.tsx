      ...
      <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
              ...
              <div key={day.day} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-white/70">{day.attendance}%</span>
          ...
          <div className="pt-4 border-t border-white/10 space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-white/70">Média Semanal</span>
              <div className="flex items-center space-x-2">
                <TrendingUp className="w-4 h-4 text-success" />
                <span className="text-lg font-bold text-white">{averageAttendance}%</span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="space-y-1">
                <p className="text-xl font-bold text-white">156</p>
                <p className="text-xs text-white/70">Total de Presenças</p>
              </div>
              <div className="space-y-1">
                <p className="text-xl font-bold text-white">160</p>
                <p className="text-xs text-white/70">Total de Aulas</p>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center space-y-2">
              ...
              <div>
                <p className="text-2xl font-bold text-white">68h</p>
                <p className="text-sm text-white/70">Carga Horária</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-4 border-t border-white/10">
            <div className="flex items-center justify-between">
              <span className="text-sm text-white/70">Aulas Realizadas</span>
              <span className="text-sm font-medium text-white">20/24</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-white/70">Taxa de Pontualidade</span>
              <span className="text-sm font-medium text-white">92%</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-white/70">Melhor Dia</span>
              <span className="text-sm font-medium text-white">Quarta-feira</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-white/70">Pior Dia</span>
              <span className="text-sm font-medium text-white">Segunda-feira</span>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="flex items-center space-x-3 p-3 bg-success/10 border border-success/20 rounded-lg">
              ...
              <div>
                <p className="font-medium text-white">Meta Semestral</p>
                <p className="text-sm text-white/70">85% de frequência atingida</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-3 bg-primary/10 border border-primary/20 rounded-lg">
              ...
              <div>
                <p className="font-medium text-white">Melhoria Contínua</p>
                <p className="text-sm text-white/70">3 semanas consecutivas acima da média</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-3 bg-accent/10 border border-accent/20 rounded-lg">
              ...
              <div>
                <p className="font-medium text-white">Participação</p>
                <p className="text-sm text-white/70">100% dos alunos com pelo menos 1 presença</p>
              </div>
            </div>
          </div>
        </CardContent>
